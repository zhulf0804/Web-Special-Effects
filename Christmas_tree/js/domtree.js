(function(){
	...
	var width = 500,
		...
		greetings = [ '圣诞节快乐','Merry Christmas','Счастливого Рождества','Frohe Weihnachten','Joyeux noel','메리 크리스마스','メリークリスマス','Feliz Natal','Buon Natale','christmas','สุขสันต์วันคริสต์มาส', 'मेरिस क्रिसमस','God jul','З Різдвом Христовим','کریسمس مبارک','Vrolijk kerstfeest','Vrolijk kerstfeest','Καλά Χριστούγεννα' ];
	//汉语, 英语, 俄语，德语, 法语, 韩语, 日语, 葡萄牙语, 意大利语, 拉丁语, 泰语, 尼泊尔语, 挪威语, 乌克兰语, 波斯语, 荷兰语, 世界语, 希腊语
